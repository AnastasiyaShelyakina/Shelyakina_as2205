...
//
//
//void GasTransportSystem::Writing_to_file() {
//	ofstream file;
...
//	file.close();
//}
//void GasTransportSystem::Read_from_file() {
//    cout << "Enter the file name: ";
//    string line;
//	INPUT_LINE(cin, line);
//    ifstream file;
...
//}
//void GasTransportSystem::EditPipe()
//{
//	if (pipe_map.size() != 0) {
//		Show(pipe_map);
//		MenuEditPipe();
...
//
//
//void GasTransportSystem::EditCS()
//{
//	if (cs_map.size() != 0) {
//		MenuEditStation();
//		switch (GetCorrectNumber(0, 3)) {
...
//
//
//std::unordered_map<int, Pipe>& GasTransportSystem::GetPipes()
//{
//	return pipe_map;
//}
//
//
//std::unordered_map<int, Cs>& GasTransportSystem::GetCS()
//{
//	return cs_map;
//}
